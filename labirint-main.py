...
wall = Wall(0,0,0,150,0,25,200)
wall2 = Wall(0,0,0,150,0,800,25)
wall3 = Wall(0,0,0,950,0,25,400)
wall4 = Wall(0,0,0,150,575,800,25)
wall5 = Wall(0,0,0,350,200,25,250)
wall6 = Wall(0,0,0,350,425,250,25)
wall7 = Wall(0,0,0,490,200,340,25)
wall8 = Wall(0,0,0,710,200,25,225)
...
while game:
    ...
    if level == 2:
        ...
        player.reset()
        player.move()
        wall = Wall(0,0,0,50,0,25,200)
        wall2 = Wall(0,0,0,50,0,900,25)
        wall4 = Wall(0,0,0,50,575,900,25)
        wall7 = Wall(0,0,0,400,200,300,25)
        wall8 = Wall(0,0,0,675,0,25,200)
        wall10 = Wall(0,0,0,50,400,25,200)
        gold.rect.y = 100
        wall3.rect.y = 200
        wall11.rect.x = 1200
        walllock.rect.y = 0
        ...
        Key.rect.y = 75
        wall5 = Wall(0,0,0,250,0,25,450)
        wall9 = Wall(0,0,0,800,0,25,450) 
        wall6 = Wall(0,0,0,400,200,25,250)
        enemy.reset()
        enemy2.reset()
        enemy3.reset()
        enemy.move3()
